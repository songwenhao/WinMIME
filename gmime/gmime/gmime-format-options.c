...
struct _GMimeFormatOptions {
	...
	GPtrArray *hidden;
	guint maxline;
    gboolean parse_richtext;
    gboolean parse_addrname;
};
...
{
    g_return_if_fail(options != NULL);
    options->parse_richtext = parse_richtext;
}
